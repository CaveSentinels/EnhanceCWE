...
class RegisterClientTest(TestCase):
    ...
    def test_check_if_client_groups_assigned(self):
        ...
        self.assertNotEqual(group1, 'contributor1')
        self.assertNotEqual(group1, 'contributor2')
        self.assertNotEqual(group2, 'contributor1')
        self.assertNotEqual(group2, 'contributor2')
        self.assertNotEqual(group1, 'none1')
        self.assertNotEqual(group2, 'none2')
    ...
    def test_check_if_contributor_groups_assigned(self):
        ...
        self.assertNotEqual(group1, 'client1')
        self.assertNotEqual(group1, 'client2')
        self.assertNotEqual(group2, 'contributor1')
        self.assertNotEqual(group2, 'contributor2')
        self.assertNotEqual(group1, 'none1')
        self.assertNotEqual(group2, 'none2')
